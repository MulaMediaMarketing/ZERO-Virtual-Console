...
int main() {
    ...
    if (!shell.Back(error) || shell.Snapshot().activePage != ShellPage::Discover) return 16;
    if (!shell.Back(error) || shell.Snapshot().activePage != ShellPage::Home) return 17;
